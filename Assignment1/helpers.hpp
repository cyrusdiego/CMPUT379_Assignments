...
inline native_commands_enum NativeCommandToEnum(std::string const &arg) {
...
inline int GetPositionInVector(std::vector<std::string> const &vec,
                               std::string word) {
...
inline std::vector<std::string> SplitStringToVector(std::string input) {
...
inline char **ConvertVectorToCharArray(
    std::vector<std::string> const &commandList) {
